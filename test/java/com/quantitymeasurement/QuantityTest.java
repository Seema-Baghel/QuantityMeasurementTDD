...
public class QuantityTest {
    ...
    double weight2,kilograms,grams,tonne,temprature1,temprature2,fahrenheit,celsius;
    ...
    public void given0FahrenheitAnd0Fahrenheit_ShouldReturnEqual() {
        temprature1 = quantity.unitConvertor(Quantity.ConversionOfUnitType.FAHRENHEIT, 0);
        temprature2 = quantity.unitConvertor(Quantity.ConversionOfUnitType.FAHRENHEIT, 0);
    ...
    public void given0FahrenheitAnd1Fahrenheit_ShouldReturnNotEqual() {
        temprature1 = quantity.unitConvertor(Quantity.ConversionOfUnitType.FAHRENHEIT, 0);
        temprature2 = quantity.unitConvertor(Quantity.ConversionOfUnitType.FAHRENHEIT, 1);
    ...
    public void given0CelsiusAnd0Celsius_ShouldReturnEqual() {
        temprature1 = quantity.unitConvertor(Quantity.ConversionOfUnitType.CELSIUS, 0);
        temprature2 = quantity.unitConvertor(Quantity.ConversionOfUnitType.CELSIUS, 0);
        Assert.assertEquals(temprature1,temprature2,0.0);
    }
    ...
    public void given0CelsiusAnd1Celsius_ShouldReturnEqual() {
        temprature1 = quantity.unitConvertor(Quantity.ConversionOfUnitType.CELSIUS, 0);
        temprature2 = quantity.unitConvertor(Quantity.ConversionOfUnitType.CELSIUS, 1);
        Assert.assertNotEquals(temprature1,temprature2,0.0);
    }
    ...
    public void givenTemperatureInFahrenheit_ShouldReturnTemperatureInCelsius() {
        fahrenheit = quantity.unitConvertor(Quantity.ConversionOfUnitType.FAHRENHEIT, 212);
        celsius = quantity.unitConvertor(Quantity.ConversionOfUnitType.CELSIUS,100);
